...
//
template <typename T>
Dynamic_Array <T>::Dynamic_Array (void) : Array <T>::cur_size_(Array <T>::defaultSize), max_size_(Array <T>::defaultSize*1.5), Array <T>::data_(nullptr)
{
	Array <T>::cur_size_ = Array <T>::defaultSize;
	max_size_ = Array <T>::defaultSize*1.5;
...
//
template <typename T>
Dynamic_Array <T>::Dynamic_Array (size_t length): Array <T>::cur_size_(Array <T>::defaultSize), max_size_(Array <T>::defaultSize*1.5), Array <T>::data_(nullptr)
{
	max_size_ = length * 1.5;
	Array <T>::cur_size_ = length;
	Array <T>::data_ = new T[max_size_];
}
...
//
template <typename T>
Dynamic_Array <T>::Dynamic_Array (size_t length, T fill): Array <T>::cur_size_(Array <T>::defaultSize), max_size_(Array <T>::defaultSize*1.5), Array <T>::data_(nullptr)
{
	max_size_ = length * 1.5;
	Array <T>::cur_size_ = length;
	Array <T>::data_ = new T[max_size_];
...
//
template <typename T>
Dynamic_Array <T>::Dynamic_Array (const Dynamic_Array & Arr): Array <T>::cur_size_(Array <T>::defaultSize), max_size_(Array <T>::defaultSize*1.5), Array <T>::data_(nullptr)
{
	Array <T>::cur_size_ = Arr.cur_size_;
